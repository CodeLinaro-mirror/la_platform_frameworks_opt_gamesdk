...
private:
    ...
    std::unique_ptr<IPredictor> default_realtime_predictor_, default_available_predictor_;
     ...
     */
    Json::object ExtractValues(IMetricsProvider::MetricsFunction metrics_function, Json fields);

...
public class InputTest {
    ...
    public void typeText_selectAll_overwrites() {
        onInputView().perform(typeTextIntoFocusedView("abcdef"), selectText(0, 6),
                typeTextIntoFocusedView("xyz"));
        checkResultText("xyz");
    }
    ...
    public void keyCharacter_sequence() {
        onInputView().perform(key(KeyEvent.KEYCODE_1), key(KeyEvent.KEYCODE_A),
                key(KeyEvent.KEYCODE_2), key(KeyEvent.KEYCODE_Z), key(KeyEvent.KEYCODE_9),
    ...
    public void keyCharacter_replaceSelection() {
        onInputView().perform(setState("BeginSelectionEnd", 5, 14), key(KeyEvent.KEYCODE_1),
    ...
    public void keyForwardDel_emoji() {
        onInputView().perform(
                setState("abc\uD83D\uDE0Dd", 3, 3), key(KeyEvent.KEYCODE_FORWARD_DEL));
        checkResultText("abcd");
    }
    ...
    public void keyForwardDel_selectionCases() {
        ...
        onInputView().perform(selectText(1, 4), key(KeyEvent.KEYCODE_FORWARD_DEL),
                typeTextIntoFocusedView("xyz"));
    ...
    public void keyDpadLeft_middle() {
        onInputView().perform(setState("abcdefgh", 6, 6), key(KeyEvent.KEYCODE_DPAD_LEFT),
    ...
    public void keyDpadRight_middle() {
        onInputView().perform(setState("abcdefgh", 6, 6), key(KeyEvent.KEYCODE_DPAD_RIGHT),
                key(KeyEvent.KEYCODE_X));
    ...
    private ViewAction setState(String text, int selectionStart, int selectionEnd) {
        return new ViewAction() {
            ...
            public void perform(UiController uiController, View view) {
                ...
                InputConnection ic = inputView.getInputConnection();
                State state =
                        new State(text, selectionStart, selectionEnd, selectionStart, selectionEnd);
                ic.setState(state);
                uiController.loopMainThreadForAtLeast(500);
            }
        };

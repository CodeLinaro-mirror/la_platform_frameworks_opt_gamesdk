...
JNIEXPORT void JNICALL Java_com_samples_cube_CubeActivity_nStopCube(JNIEnv* env, jobject clazz) {
    if (state.running) {
...
JNIEXPORT void JNICALL Java_com_samples_cube_CubeActivity_nUpdateGpuWorkload(JNIEnv* env,
                                                                             jobject clazz,
                                                                             jint new_workload) {
    update_gpu_workload(new_workload);
}

JNIEXPORT void JNICALL Java_com_samples_cube_CubeActivity_nUpdateCpuWorkload(JNIEnv* env,
                                                                             jobject clazz,
                                                                             jint new_workload) {

...
public:
    ...
    void SerializeEvent(const RequestInfo& device_info, std::string& evt_json_ser);

    void SerializeLifecycleEvent(const LifecycleUploadEvent& event, const RequestInfo& request_info,
                                 std::string& evt_json_ser);

    static TuningFork_ErrorCode DeserializeAndMerge(const std::string& evt_json_ser,
                                                    IdProvider& id_provider, Session& session);
...
private:
    ...
    json11::Json::object TelemetryReportJson(const AnnotationId& annotation, bool& empty,
                                             Duration& duration);

    json11::Json::object PartialLoadingTelemetryReportJson(const AnnotationId& annotation,
    ...
    json11::Json::object PartialLoadingTelemetryJson(const AnnotationId& annotation,
                                                     const LifecycleUploadEvent& event,
                                                     const RequestInfo& request_info);

    json11::Json::object LoadingTimeMetadataJson(const LoadingTimeMetadataWithGroup& md);
    std::vector<json11::Json::object> CrashReportsJson(const RequestInfo& request_info);

    void SerializeTelemetryRequest(const RequestInfo& request_info,

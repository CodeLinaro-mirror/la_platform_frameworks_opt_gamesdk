...
public final class DeveloperTuningforkParserTest {
    ...
    private final Settings settings =
            Settings.newBuilder()
                    .setAggregationStrategy(AggregationStrategy.newBuilder()
    ...
    private final FidelityParams devParameters1 = FidelityParams.newBuilder()
                                                          .setIntField(10)
                                                          .setFloatField(1.5f)
                                                          .setQualitySettings(QualitySettings.FAST)
                                                          .build();

    private final FidelityParams devParameters2 =
            FidelityParams.newBuilder().setIntField(10).build();
    ...
    public void checkFidelityParameters() throws Exception {
        parser.validate();
        File devFidelityFile =
                new File(tempFolder.getRoot(), "dev_tuningfork_fidelityparams_1.bin");

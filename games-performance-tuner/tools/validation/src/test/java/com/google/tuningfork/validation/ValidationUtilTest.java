...
public final class ValidationUtilTest {
    ...
    public void settingsWithHistogramsValid() throws Exception {
        AggregationStrategy aggregation = AggregationStrategy.newBuilder()
    ...
    public void settingsHistogramsValid() throws Exception {
        Settings settings =
                Settings.newBuilder().addHistograms(Histogram.getDefaultInstance()).build();
    ...
    public void devFidelityParamsValid() throws Exception {
        ByteString content =
                TestdataHelper.readByteString("dev_tuningfork_fidelityparams_valid.bin");
        Descriptor desc = helper.getDescriptor("fidelity_params_valid.proto",
                "Getting FidelityParams field from proto", "FidelityParams");
    ...
    public void fidelityParamsComplex() throws Exception {
        Descriptor desc = helper.getDescriptor("fidelity_params_complex.proto",
                "Getting FidelityParams field from proto", "FidelityParams");
    ...
    public void fidelityParamsNotScalar() throws Exception {
        Descriptor desc = helper.getDescriptor("fidelity_params_not_scalar.proto",
                "Getting FidelityParams field from proto", "FidelityParams");
        assertThat(desc).isNotNull();
        ValidationUtil.validateFidelityParams(desc, errors);
    ...
    public void annotationComplex() throws Exception {
        Descriptor desc = helper.getDescriptor(
    ...
    public void annotationNotOnlyEnums() throws Exception {
        Descriptor desc = helper.getDescriptor("annotation_not_only_enums.proto",
                "Getting Annotation field from proto", "Annotation");
        assertThat(desc).isNotNull();
    ...
    public void checkZeroEnumWarning() throws Exception {
        Descriptor desc = helper.getDescriptor("dev_tuningfork.proto",
                "Getting FidelityParams field from proto", "FidelityParams");
        ...
        assertThat(errors.getWarningCount(ErrorType.DEV_FIDELITY_PARAMETERS_ENUMS_ZERO))
                .isEqualTo(1);
    }

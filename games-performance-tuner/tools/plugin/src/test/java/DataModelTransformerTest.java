...
public class DataModelTransformerTest {
    ...
    public void transformToAnnotation() throws IOException, CompilationException {
        ...
        MessageDataModel annotationDataModel =
                DataModelTransformer.transformToAnnotation(messageDesc).get();
    ...
    public void transformToFidelity() throws IOException, CompilationException {
        ...
        MessageDataModel fidelityDataModel =
                DataModelTransformer.transformToFidelity(messageDesc).get();
    ...
    public void transformToQuality() throws IOException, CompilationException {
        ...
        DynamicMessage dynamicMessage =
                DynamicMessage.newBuilder(messageDesc)
        ...
        QualityDataModel qualityDataModel =
                DataModelTransformer.transformToQuality(dynamicMessage, messageDesc.getFields())
                        .get();

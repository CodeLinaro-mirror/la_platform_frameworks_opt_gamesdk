...
public class FidelityTableDecorators {
    public static final class FidelityFieldComboBox extends BaseComboBoxTableCell {
        ...
        public FidelityFieldComboBox(
                TableComboBox<FieldType> tableComboBox, FieldType[] fieldTypes) {
            super(tableComboBox);
    ...
    public static class JPanelDecorator
        ...
        public Component getTableCellEditorComponent(
            ...
            fidelityTablePanel.getTextFieldPanel().getTextField().setBackground(
        ...
        public Component getTableCellRendererComponent(JTable table, Object value,
            ...
            if (enums.contains(fidelityTableData.getFieldEnumName())) {
                fidelityTablePanel.getEnumTypes().setSelectedItem(
                        fidelityTableData.getFieldEnumName());
            } else {

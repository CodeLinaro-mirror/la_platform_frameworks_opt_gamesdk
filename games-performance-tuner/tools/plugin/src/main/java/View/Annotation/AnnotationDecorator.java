...
public class AnnotationDecorator {
    public static class EnumComboBoxDecorator extends BaseComboBoxTableCell {
        ...
        public EnumComboBoxDecorator(
                TableComboBox<String> tableComboBox, List<EnumDataModel> enumsTemp) {
            super(tableComboBox);
        ...
        public Component getTableCellEditorComponent(
            ...
            tableComboBox.setForeground(
                    isSelected ? table.getSelectionForeground() : table.getForeground());
            tableComboBox.setBackground(
        ...
        public Component getTableCellRendererComponent(JTable table, Object value,
            ...
            String strValue = value.toString();
            setComboBoxChoices(enums);
            if (enums.stream().anyMatch(
                        enumDataModel -> enumDataModel.getName().equals(strValue))) {
                tableComboBox.setSelectedItem(strValue);
            } else {

...
public final class ProtoCompiler {
    ...
    private static final String PROTO_BINARY_PATH_RELATIVE_TO_JAR =
            PROTO_FOLDER_PATH_RELATIVE_TO_JAR + "/bin/"
            + OsUtils.getOS().getExecutableProtoFileName();
    ...
    private ProtoCompiler() {
        try {
            ...
            protocBinary = new File(
                    temporaryFolderRoot.getAbsolutePath(), PROTO_BINARY_PATH_RELATIVE_TO_JAR);

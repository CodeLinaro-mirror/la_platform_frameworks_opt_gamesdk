...
using PFN_AChoreographer_postVsyncCallback = void (*)(AChoreographer* choreographer,
...
private:
    ...
    PFN_AChoreographer_postVsyncCallback mAChoreographer_postVsyncCallback = nullptr;
...
NDKChoreographerThread::NDKChoreographerThread(ChoreographerCallback onChoreographer,
    ...
    mAChoreographer_postVsyncCallback = reinterpret_cast<PFN_AChoreographer_postVsyncCallback>(
            dlsym(mLibAndroid, "AChoreographer_postVsyncCallback"));

    mAChoreographerFrameCallbackData_getPreferredFrameTimelineIndex =
            reinterpret_cast<PFN_AChoreographerFrameCallbackData_getPreferredFrameTimelineIndex>(
                    dlsym(mLibAndroid,
                          "AChoreographerFrameCallbackData_"
                          "getPreferredFrameTimelineIndex"));

    mAChoreographerFrameCallbackData_getFrameTimelineExpectedPresentationTimeNanos = reinterpret_cast<
            PFN_AChoreographerFrameCallbackData_getFrameTimelineExpectedPresentationTimeNanos>(
            dlsym(mLibAndroid,
                  "AChoreographerFrameCallbackData_"
    ...
    mAChoreographerFrameCallbackData_getFrameTimelineDeadlineNanos =
            reinterpret_cast<PFN_AChoreographerFrameCallbackData_getFrameTimelineDeadlineNanos>(
                    dlsym(mLibAndroid,
                          "AChoreographerFrameCallbackData_"
...
void NDKChoreographerThread::scheduleNextFrameCallback() {
    if (mAChoreographer_postVsyncCallback) {
        AChoreographer_vsyncCallback frameCallback = [](const AChoreographerFrameCallbackData*
            ...
            const auto idx =
                    me->mAChoreographerFrameCallbackData_getPreferredFrameTimelineIndex(frameData);
            ...
            const auto expectedDeadline =
                    me->mAChoreographerFrameCallbackData_getFrameTimelineDeadlineNanos(frameData,
                                                                                       idx);

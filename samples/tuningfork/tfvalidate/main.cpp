...
int validateApk(const char* apk_path, const std::string asset_path,
                bool enforce_enums_in_annotations, bool check_dev_fidelityparams, bool debug) {
#undef open
    std::shared_ptr<android::ZipFileRO> zipFile(android::ZipFileRO::open(apk_path));
#define open ___xxx_unix_open
    ...
    return validator.Validate(enforce_enums_in_annotations, check_dev_fidelityparams);
}

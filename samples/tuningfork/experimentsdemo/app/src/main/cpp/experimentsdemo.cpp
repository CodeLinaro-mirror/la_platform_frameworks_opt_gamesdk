...
JNIEXPORT void JNICALL Java_com_tuningfork_experimentsdemo_TFTestActivity_initTuningFork(
...
JNIEXPORT void JNICALL Java_com_tuningfork_experimentsdemo_TFTestActivity_onChoreographer(
...
JNIEXPORT void JNICALL Java_com_tuningfork_experimentsdemo_TFTestActivity_resize(
...
JNIEXPORT void JNICALL Java_com_tuningfork_experimentsdemo_TFTestActivity_start(JNIEnv* /*env*/,
                                                                                jclass /*clz*/) {
    TuningFork_reportLifecycleEvent(TUNINGFORK_STATE_ONSTART);
    Renderer::getInstance()->start();
}
JNIEXPORT void JNICALL Java_com_tuningfork_experimentsdemo_TFTestActivity_stop(JNIEnv* /*env*/,
                                                                               jclass /*clz*/) {
...
JNIEXPORT void JNICALL Java_com_tuningfork_experimentsdemo_TFTestActivity_destroy(JNIEnv* /*env*/,
                                                                                  jclass /*clz*/) {
    TuningFork_reportLifecycleEvent(TUNINGFORK_STATE_ONDESTROY);
    TuningFork_destroy();
}

JNIEXPORT void JNICALL Java_com_tuningfork_experimentsdemo_TFTestActivity_raiseSignal(JNIEnv* env,
                                                                                      jclass clz,
                                                                                      jint signal) {
    std::stringstream ss;
    ss << std::this_thread::get_id();
    ALOGI("raiseSignal %d: [pid: %d], [tid: %d], [thread_id: %s])", signal, getpid(), gettid(),
          ss.str().c_str());
    raise(signal);
}

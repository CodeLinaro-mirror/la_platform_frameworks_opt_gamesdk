...
void InitTf(JNIEnv* env, jobject activity) {
    ...
    if (TuningFork_findFidelityParamsInApk(env, activity, filename, &fps) == TUNINGFORK_ERROR_OK)
...
JNIEXPORT void JNICALL Java_com_tuningfork_insightsdemo_TFTestActivity_initTuningFork(
...
JNIEXPORT void JNICALL Java_com_tuningfork_insightsdemo_TFTestActivity_onChoreographer(
...
JNIEXPORT void JNICALL Java_com_tuningfork_insightsdemo_TFTestActivity_start(JNIEnv* /*env*/,
                                                                             jclass /*clz*/) {
    TuningFork_reportLifecycleEvent(TUNINGFORK_STATE_ONSTART);
    Renderer::getInstance()->start();
}
JNIEXPORT void JNICALL Java_com_tuningfork_insightsdemo_TFTestActivity_stop(JNIEnv* /*env*/,
                                                                            jclass /*clz*/) {
...
JNIEXPORT void JNICALL Java_com_tuningfork_insightsdemo_TFTestActivity_destroy(JNIEnv* /*env*/,
                                                                               jclass /*clz*/) {
    TuningFork_reportLifecycleEvent(TUNINGFORK_STATE_ONDESTROY);
    TuningFork_destroy();
}

JNIEXPORT void JNICALL Java_com_tuningfork_insightsdemo_TFTestActivity_raiseSignal(JNIEnv* env,
                                                                                   jclass clz,
                                                                                   jint signal) {
    std::stringstream ss;

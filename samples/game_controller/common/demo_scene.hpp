...
private:
    ...
    enum SimulatedClickState { SIMULATED_CLICK_NONE = 0, SIMULATED_CLICK_DOWN, SIMULATED_CLICK_UP };
...
protected:
    ...
    void RenderMotionTableData(const float* motionData, const uint32_t accelTimestampDelta,
                               const uint32_t gyroTimestampDelta, bool hasAccel, bool hasGyro);
...
public:
    ...
    void MotionDataEvent(const int32_t controllerIndex, const Paddleboat_Motion_Data* motionData);

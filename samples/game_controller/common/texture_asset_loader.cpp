...
TextureAssetHandle loadTextureAsset_LIBPNG(const char* filename, uint32_t* textureWidth,
            ...
            if (textureFileBytes != nullptr) {
                ...
                if (png_sig_cmp(static_cast<png_const_bytep>(textureFileBytes), 0,
                    ...
                    if (pngStruct != nullptr) {
                        ...
                        if (pngInfo != nullptr) {
                            PNG_Memory_Stream memoryStream{static_cast<uint8_t*>(textureFileBytes),
                                                           PNG_SIG_LENGTH, textureFileSize};
                            ...
                            int pngDepth = 0;
                            int pngColorType = -1;
                            if (png_get_IHDR(pngStruct, pngInfo, &pngWidth, &pngHeight, &pngDepth,
                                             &pngColorType, NULL, NULL, NULL) == 1) {

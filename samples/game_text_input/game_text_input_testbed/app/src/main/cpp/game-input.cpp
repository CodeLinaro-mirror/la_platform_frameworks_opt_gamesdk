...
static void onEvent(void* context, const GameTextInputState* state) {
    ...
    env->CallVoidMethod(activity, setDisplayedText, currentText, state->selection.start,
                        state->selection.end);
}
...
Java_com_gametextinput_testbed_MainActivity_onCreated(JNIEnv* env, jobject thiz) {
    ...
    setDisplayedText =
            env->GetMethodID(activityClass, "setDisplayedText", "(Ljava/lang/String;II)V");
...
extern "C" JNIEXPORT void JNICALL
Java_com_gametextinput_testbed_MainActivity_setInputConnectionNative(JNIEnv* env, jobject thiz,
...
extern "C" JNIEXPORT void JNICALL
Java_com_gametextinput_testbed_MainActivity_sendSelectionToStart(JNIEnv* env, jobject thiz) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_gametextinput_testbed_MainActivity_sendSelectionToEnd(JNIEnv* env, jobject thiz) {
    GameTextInput_getState(
            gameTextInput,
            [](void* context, const GameTextInputState* state) {
                GameTextInputState state_copy = *state;

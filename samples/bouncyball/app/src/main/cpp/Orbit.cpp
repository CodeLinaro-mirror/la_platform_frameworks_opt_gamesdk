...
static SwappyThreadFunctions sThreadFunctions = {threadStart, threadJoin, threadJoinable};
/**/
...
JNIEXPORT void JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nSetSurface(
...
JNIEXPORT void JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nClearSurface(
        JNIEnv* /* env */, jobject /* this */) {
    Renderer::getInstance()->setWindow(nullptr, 0, 0);
}

JNIEXPORT void JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nStart(JNIEnv* /* env */,
                                                                             jobject /* this */) {
    ALOGI("start");
...
JNIEXPORT void JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nStop(JNIEnv* /* env */,
                                                                            jobject /* this */) {
    ALOGI("stop");
    Renderer::getInstance()->stop();
}

JNIEXPORT void JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nSetPreference(
...
JNIEXPORT void JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nSetAutoSwapInterval(
        JNIEnv* env, jobject /* this */, jboolean enabled) {
    SwappyGL_setAutoSwapInterval(enabled);
}

JNIEXPORT void JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nSetAutoPipeline(
        JNIEnv* env, jobject /* this */, jboolean enabled) {
    SwappyGL_setAutoPipelineMode(enabled);
}

JNIEXPORT float JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nGetAverageFps(
        JNIEnv* /* env */, jobject /* this */) {
    return Renderer::getInstance()->getAverageFps();
}

JNIEXPORT float JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nGetRefreshPeriodNS(
        JNIEnv* /* env */, jobject /* this */) {
    return SwappyGL_getRefreshPeriodNanos();
}

JNIEXPORT float JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nGetSwapIntervalNS(
        JNIEnv* /* env */, jobject /* this */) {
    return SwappyGL_getSwapIntervalNS();
}

JNIEXPORT float JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nGetPipelineFrameTimeNS(
        JNIEnv* /* env */, jobject /* this */) {
    return Renderer::getInstance()->frameTimeStats().mean();
}
JNIEXPORT float JNICALL
Java_com_prefabulated_bouncyball_OrbitActivity_nGetPipelineFrameTimeStdDevNS(JNIEnv* /* env */,
                                                                             jobject /* this */) {
    return sqrt(Renderer::getInstance()->frameTimeStats().var());
}

JNIEXPORT void JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nSetWorkload(
        JNIEnv* /* env */, jobject /* this */, jint load) {
    Renderer::getInstance()->setWorkload(load);
}

JNIEXPORT void JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nSetBufferStuffingFixWait(
        JNIEnv* /* env */, jobject /* this */, jint n_frames) {
    SwappyGL_setBufferStuffingFixWait(n_frames);
}

JNIEXPORT void JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nEnableSwappy(
        JNIEnv* /* env */, jobject /* this */, jboolean enabled) {
    Renderer::getInstance()->setSwappyEnabled(enabled);
}

JNIEXPORT int JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nGetSwappyStats(
...
JNIEXPORT jlong JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nGetSwappyVersion(
        JNIEnv* /* env */, jobject /* this */) {
    return SWAPPY_MAJOR_VERSION * 10000L + SWAPPY_MINOR_VERSION * 100L + SWAPPY_BUGFIX_VERSION;
}

JNIEXPORT void JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nSetEnableFramePacing(
        JNIEnv* env, jobject /* this */, jboolean enabled) {
    SwappyGL_enableFramePacing(enabled);
}

JNIEXPORT void JNICALL Java_com_prefabulated_bouncyball_OrbitActivity_nSetEnableBlockingWait(
        JNIEnv* env, jobject /* this */, jboolean enabled) {

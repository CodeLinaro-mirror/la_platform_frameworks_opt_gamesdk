...
static int _synth(int frequency, int /*duration*/, float amplitude, int16_t* sample_buf,
                  int samples) {
    int i;
...
oboe::DataCallbackResult SfxMan::onAudioReady(oboe::AudioStream* /*audioStream*/, void* audioData,
                                              int32_t numFrames) {
    if (_frameCount > 0) {

...
private:
    ...
    void Init(Texture* t, OurShader* shader, float aspect, float umin, float vmin, float umax,
              float vmax) {
        mTexture = t;
        mOurShader = shader;
        mAspect = aspect;
...
public:
    TexQuad(Texture* t, OurShader* shader, float aspect, float umin, float vmin, float umax,
            float vmax) {
        Init(t, shader, aspect, umin, vmin, umax, vmax);
    }

    TexQuad(Texture* t, OurShader* shader, float umin, float vmin, float umax, float vmax) {

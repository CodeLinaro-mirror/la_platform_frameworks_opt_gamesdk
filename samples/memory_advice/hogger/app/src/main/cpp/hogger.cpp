...
Java_com_memory_1advice_hogger_MainActivity_initMemoryAdvice(JNIEnv* env, jobject activity) {
...
Java_com_memory_1advice_hogger_MainActivity_getMemoryAdvice(JNIEnv* env, jobject activity) {
...
Java_com_memory_1advice_hogger_MainActivity_getPercentageMemoryAvailable(JNIEnv* env,
                                                                         jobject activity) {
    return MemoryAdvice_getPercentageAvailableMemory();
}

extern "C" JNIEXPORT jint JNICALL
Java_com_memory_1advice_hogger_MainActivity_getMemoryState(JNIEnv* env, jobject activity) {
...
Java_com_memory_1advice_hogger_MainActivity_allocate(JNIEnv* env, jobject activity, jlong nbytes) {
...
Java_com_memory_1advice_hogger_MainActivity_deallocate(JNIEnv* env, jobject activity) {
    std::lock_guard<std::mutex> guard(allocated_mutex);

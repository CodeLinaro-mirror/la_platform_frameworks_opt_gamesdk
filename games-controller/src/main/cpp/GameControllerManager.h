...
public:
    ...
    static Paddleboat_ErrorCode setControllerLight(const int32_t controllerIndex,
                                                   const Paddleboat_LightType lightType,
                                                   const uint32_t lightData, JNIEnv* env);

    static void setControllerStatusCallback(Paddleboat_ControllerStatusCallback statusCallback,
                                            void* userData);
    ...
    static void setMouseStatusCallback(Paddleboat_MouseStatusCallback statusCallback,
                                       void* userData);
    ...
    static Paddleboat_ErrorCode getControllerInfo(const int32_t controllerIndex,
                                                  Paddleboat_Controller_Info* deviceInfo);
    ...
    static int32_t processGameActivityMotionInputEvent(const void* event, const size_t eventSize);
    ...
    static void onMotionData(const int32_t deviceId, const int32_t motionType,
                             const uint64_t timestamp, const float dataX, const float dataY,
                             const float dataZ);
...
private:
    ...
    const float* getAxisValuesFromGameActivityMotionEvent(const void* event, const size_t eventSize,
    ...
    int32_t processControllerKeyEvent(const AInputEvent* event, GameController& gameController);
    ...
    int32_t processGameActivityMouseEvent(const void* event, const size_t eventSize,

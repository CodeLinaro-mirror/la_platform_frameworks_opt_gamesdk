...
public:
    ...
    const InfoFields& getInfo() const {
        return mInfo;
    }

    const float* getMinArray() const {
        return mAxisMinArray;
    }

    const float* getMaxArray() const {
        return mAxisMaxArray;
    }

    const float* getFlatArray() const {
        return mAxisFlatArray;
    }

    const float* getFuzzArray() const {
        return mAxisFuzzArray;
    }

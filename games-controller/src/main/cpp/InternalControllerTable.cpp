...
const Paddleboat_Controller_Mapping_File_Controller_Entry pb_internal_controller_table[] =
        {{// Steelseries Nimbus (bluetooth)
          16, 00, 0x0111, 0x1420, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD, 2, 6, 0, 0},
         {// Microsoft Xbox 360 controller (usb)
          16, 00, 0x045e, 0x028e, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD, 0, 0, 0, 0},
         {// Microsoft Xbox One non-BT controller (usb)
          16, 00, 0x045e, 0x02d1, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD, 0, 0, 0, 0},
         {// 8BitDo Arcade Stick, XInput mode, Bluetooth
          16, 00, 0x045e, 0x02e0, PADDLEBOAT_CONTROLLER_LAYOUT_ARCADE_STICK, 0, 0, 0, 0},
         {// Microsoft Xbox One BT controller (usb)
          16, 00, 0x045e, 0x02ea, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD, 0, 0, 0, 0},
         {// Microsoft Xbox One BT controller (bluetooth)
          16, 00, 0x045e, 0x02fd, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD, 0, 0, 0, 0},
         {// Microsoft Xbox Series controller (usb)
          16, 00, 0x045e, 0x0b12, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD, 0, 0, 0, 0},
         {//  Microsoft Xbox Series controller (bluetooth)
          16, 00, 0x045e, 0x0b13, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD, 0, 0, 0, 0},
         {//  Sony PlayStation 4 controller (usb/bluetooth)
          16, 00, 0x054C, 0x05C4,
          PADDLEBOAT_CONTROLLER_LAYOUT_SHAPES | PADDLEBOAT_CONTROLLER_FLAG_TOUCHPAD, 0, 1, 0, 0},
         {//  Sony PlayStation 4 controller (usb/bluetooth) - alternate deviceId
          16, 00, 0x054C, 0x09CC,
          PADDLEBOAT_CONTROLLER_LAYOUT_SHAPES | PADDLEBOAT_CONTROLLER_FLAG_TOUCHPAD, 0, 1, 0, 0},
         {//  Sony PlayStation 5 controller (usb/bluetooth) API <= 30
          16, 30, 0x054C, 0x0CE6, PADDLEBOAT_CONTROLLER_LAYOUT_SHAPES, 1, 2, 0, 0},
         {//  Sony PlayStation 5 controller (usb/bluetooth) API >= 31
          31, 00, 0x054C, 0x0CE6,
          PADDLEBOAT_CONTROLLER_LAYOUT_SHAPES | PADDLEBOAT_CONTROLLER_FLAG_TOUCHPAD, 0, 1, 0, 0},
         {//  Nintendo Switch Pro controller (usb/bluetooth)
          16, 30, 0x057e, 0x2009, PADDLEBOAT_CONTROLLER_LAYOUT_REVERSE, 0, 3, 0, 0},
         {//  Nvidia Shield TV controller (usb)
          16, 00, 0x0955, 0x7210, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD, 0, 4, 0, 0},
         {//  Google Stadia controller (usb)
          16, 00, 0x18d1, 0x9400, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD, 0, 4, 0, 0},
         {//  NeoGeo Pro, PC 2 setting, USB
          16, 00, 0x20bc, 0x5501, PADDLEBOAT_CONTROLLER_LAYOUT_ARCADE_STICK, 0, 5, 0, 0},
         {// Razer Kishi v1 (usb)
          16, 00, 0x27f8, 0x0bbf, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD, 0, 0, 0, 0}};

...
#define PADDLEBOAT_VERSION_REVISION 7cd950d0022d01f1e7e2b470aba5a7b1abacdfaa
#define PADDLEBOAT_MAJOR_VERSION 2
#define PADDLEBOAT_MINOR_VERSION 3
#define PADDLEBOAT_BUGFIX_VERSION 0
#define PADDLEBOAT_PACKED_VERSION                                                      \
    ANDROID_GAMESDK_PACKED_VERSION(PADDLEBOAT_MAJOR_VERSION, PADDLEBOAT_MINOR_VERSION, \
...
typedef void (*Paddleboat_ControllerStatusCallback)(
        const int32_t controllerIndex, const Paddleboat_ControllerStatus controllerStatus,
        void* userData);
 ...
 * Function will be called on the same thread that calls ::Paddleboat_update.
 */
typedef void (*Paddleboat_PhysicalKeyboardStatusCallback)(const bool physicalKeyboardStatus,
                                                          void* userData);
...
Paddleboat_ErrorCode Paddleboat_setControllerVibrationData(
        const int32_t controllerIndex, const Paddleboat_Vibration_Data* vibrationData, JNIEnv* env);
/**

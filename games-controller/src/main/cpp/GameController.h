...
public:
    ...
    void setupController(const Paddleboat_Controller_Mapping_File_Controller_Entry* controllerEntry,
    ...
    uint64_t getControllerAxisMask() const {
        return mControllerAxisMask;
    }

    Paddleboat_Controller_Data& getControllerData() {
    ...
    Paddleboat_Controller_Info& getControllerInfo() {
    ...
    GameControllerDeviceInfo& getDeviceInfo() {
        return mDeviceInfo;
    }
    ...
    GameControllerAxisInfo* getAxisInfo() {
        return mAxisInfo;
    }

    const GameControllerAxisInfo* getAxisInfo() const {
        return mAxisInfo;
    }

    bool getControllerDataDirty() const {
        return mControllerDataDirty;
    }

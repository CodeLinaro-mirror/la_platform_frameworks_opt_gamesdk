...
#define TUNINGFORK_VERSION_REVISION 7cd950d0022d01f1e7e2b470aba5a7b1abacdfaa
...
typedef enum TuningFork_ErrorCode {
    ...
    TUNINGFORK_ERROR_NO_SETTINGS = 1, ///< No tuningfork_settings.bin found in assets/tuningfork.
    TUNINGFORK_ERROR_NO_SWAPPY = 2,   ///< Not able to find the required Swappy functions.
    TUNINGFORK_ERROR_INVALID_DEFAULT_FIDELITY_PARAMS = 3, ///< `fpDefaultFileNum` is out of range.
    TUNINGFORK_ERROR_NO_FIDELITY_PARAMS = 4, ///< No fidelity parameters found at initialization.
    ...
    TUNINGFORK_ERROR_NO_FIDELITY_PARAMS_IN_APK = 18, ///< No dev_tuningfork_fidelityparams_#.bin
                                                     ///< found in assets/tuningfork.
    ...
    TUNINGFORK_ERROR_UPLOAD_TOO_FREQUENT = 21, ///< Too frequent calls to `TuningFork_flush`.
    ...
    TUNINGFORK_ERROR_ALREADY_INITIALIZED = 25, ///< TuningFork_init was called more than once.
    ...
    TUNINGFORK_ERROR_INVALID_LOADING_HANDLE = 33, ///< Invalid handle passed to
    ...
    TUNINGFORK_ERROR_INVALID_LOADING_STATE = 36, ///< The loading state was not set as part of
                                                 ///< TuningFork_LoadingTimeMetadata when calling a
                                                 ///< loading function.
    TUNINGFORK_ERROR_NO_ACTIVE_LOADING_GROUP = 37, ///< There was no active loading group when
 ...
 * initialized.
 */
TuningFork_ErrorCode TuningFork_init(const TuningFork_Settings* settings, JNIEnv* env,
                                     jobject context);
 ...
 * @return TUNINGFORK_ERROR_OK on success.
 */
TuningFork_ErrorCode TuningFork_frameDeltaTimeNanos(TuningFork_InstrumentKey key,
...
typedef struct TuningFork_LoadingTimeMetadata {
    ...
    enum NetworkConnectivity { UNKNOWN = 0, WIFI = 1, CELLULAR_NETWORK = 2 } network_connectivity;
...
TuningFork_ErrorCode TuningFork_startRecordingLoadingTime(
        const TuningFork_LoadingTimeMetadata* eventMetadata, uint32_t eventMetadataSize,
        const TuningFork_CProtobufSerialization* annotation, TuningFork_LoadingEventHandle* handle);
...
TuningFork_ErrorCode TuningFork_startLoadingGroup(
        const TuningFork_LoadingTimeMetadata* eventMetadata, uint32_t eventMetadataSize,
        const TuningFork_CProtobufSerialization* annotation, TuningFork_LoadingGroupHandle* handle);

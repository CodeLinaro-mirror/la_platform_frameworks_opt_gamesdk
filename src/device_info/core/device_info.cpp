...
void splitAddUnique(char* toSplit, const char* delimiters, StringVector& result) {
    char* strtokState;
...
bool readCpuFreqMax(int cpuIndex, int64_t& result) {
    char fileName[64];
    snprintf(fileName, sizeof(fileName), "%s%d%s", "/sys/devices/system/cpu/cpu", cpuIndex,
...
bool readCpuExtensions(ProtoDataHolder& dataHolder) {
    ...
    while (true) {
        ...
        if (::string_util::startsWith(line.get(), FIELD_KEY)) {
            ...
            // after.
            ::string_util::splitAddUnique(const_cast<char*>(value), " ", dataHolder.cpu_extension);
        }
    }
    return true;
}
...
int addSystemProperties(ProtoDataHolder& dataHolder) {
    int numErrors = 0;
    numErrors += getSystemProp("ro.build.version.sdk", dataHolder.ro_build_version_sdk,
                               dataHolder.errors);
    numErrors += getSystemProp("ro.build.fingerprint", dataHolder.ro_build_fingerprint,
                               dataHolder.errors);
    return numErrors;
}
...
int setupEGl(EGLDisplay& display, EGLContext& context, EGLSurface& surface, StringVector& errors) {
    ...
    EGLint pbufferAttribs[] = {EGL_WIDTH, androidgamesdk_deviceinfo::OPENGL_TEST_VIEW_WIDTH,
...
void addOglConstsV2_0(androidgamesdk_deviceinfo_GameSdkDeviceInfo_OpenGl& proto,
    ...
    glGetFloatv(GL_ALIASED_LINE_WIDTH_RANGE, dataHolder.gl_aliased_line_width_range.data.get());

    dataHolder.gl_aliased_point_size_range.setSize(2);
    glGetFloatv(GL_ALIASED_POINT_SIZE_RANGE, dataHolder.gl_aliased_point_size_range.data.get());
    ...
    proto.gl_max_cube_map_texture_size = ::ogl_util::getInt(GL_MAX_CUBE_MAP_TEXTURE_SIZE);
    proto.has_gl_max_fragment_uniform_vectors = true;
    proto.gl_max_fragment_uniform_vectors = ::ogl_util::getInt(GL_MAX_FRAGMENT_UNIFORM_VECTORS);
    ...
    proto.gl_max_texture_image_units = ::ogl_util::getInt(GL_MAX_TEXTURE_IMAGE_UNITS);
    ...
    proto.gl_max_vertex_texture_image_units = ::ogl_util::getInt(GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS);
    proto.has_gl_max_vertex_uniform_vectors = true;
    proto.gl_max_vertex_uniform_vectors = ::ogl_util::getInt(GL_MAX_VERTEX_UNIFORM_VECTORS);

    dataHolder.gl_max_viewport_dims.setSize(2);
    glGetIntegerv(GL_MAX_VIEWPORT_DIMS, dataHolder.gl_max_viewport_dims.data.get());
    ...
    GLint numCompressedFormats = ::ogl_util::getInt(GL_NUM_COMPRESSED_TEXTURE_FORMATS);
    ...
    glGetIntegerv(GL_COMPRESSED_TEXTURE_FORMATS, dataHolder.compTexFormats.data.get());
    ...
    glGetIntegerv(GL_SHADER_BINARY_FORMATS, dataHolder.shaderBinFormats.data.get());
...
void addOglConstsV3_0(androidgamesdk_deviceinfo_GameSdkDeviceInfo_OpenGl& proto,
    ...
    proto.gl_max_array_texture_layers = ::ogl_util::getInt(GL_MAX_ARRAY_TEXTURE_LAYERS);
    ...
    proto.gl_max_combined_uniform_blocks = ::ogl_util::getInt(GL_MAX_COMBINED_UNIFORM_BLOCKS);
    ...
    proto.gl_max_fragment_input_components = ::ogl_util::getInt(GL_MAX_FRAGMENT_INPUT_COMPONENTS);
    proto.has_gl_max_fragment_uniform_blocks = true;
    proto.gl_max_fragment_uniform_blocks = ::ogl_util::getInt(GL_MAX_FRAGMENT_UNIFORM_BLOCKS);
    ...
    proto.gl_max_program_texel_offset = ::ogl_util::getInt(GL_MAX_PROGRAM_TEXEL_OFFSET);
    ...
    proto.gl_max_uniform_buffer_bindings = ::ogl_util::getInt(GL_MAX_UNIFORM_BUFFER_BINDINGS);
    proto.has_gl_max_varying_components = true;
    proto.gl_max_varying_components = ::ogl_util::getInt(GL_MAX_VARYING_COMPONENTS);
    proto.has_gl_max_vertex_output_components = true;
    proto.gl_max_vertex_output_components = ::ogl_util::getInt(GL_MAX_VERTEX_OUTPUT_COMPONENTS);
    proto.has_gl_max_vertex_uniform_blocks = true;
    proto.gl_max_vertex_uniform_blocks = ::ogl_util::getInt(GL_MAX_VERTEX_UNIFORM_BLOCKS);
    proto.has_gl_max_vertex_uniform_components = true;
    proto.gl_max_vertex_uniform_components = ::ogl_util::getInt(GL_MAX_VERTEX_UNIFORM_COMPONENTS);
    proto.has_gl_min_program_texel_offset = true;
    proto.gl_min_program_texel_offset = ::ogl_util::getInt(GL_MIN_PROGRAM_TEXEL_OFFSET);
    ...
    ::ogl_util::glGetInteger64v = reinterpret_cast<::ogl_util::FuncTypeGlGetInteger64v>(
    ...
    proto.gl_max_server_wait_timeout = ::ogl_util::getInt64(GL_MAX_SERVER_WAIT_TIMEOUT);
    proto.has_gl_max_uniform_block_size = true;
    proto.gl_max_uniform_block_size = ::ogl_util::getInt64(GL_MAX_UNIFORM_BLOCK_SIZE);
    ...
    glGetIntegerv(GL_PROGRAM_BINARY_FORMATS, dataHolder.progBinFormats.data.get());
}
...
void addOglConstsV3_1(androidgamesdk_deviceinfo_GameSdkDeviceInfo_OpenGl& proto) {
    ...
    proto.gl_max_atomic_counter_buffer_size = ::ogl_util::getInt(GL_MAX_ATOMIC_COUNTER_BUFFER_SIZE);
    proto.has_gl_max_color_texture_samples = true;
    proto.gl_max_color_texture_samples = ::ogl_util::getInt(GL_MAX_COLOR_TEXTURE_SAMPLES);
    proto.has_gl_max_combined_atomic_counters = true;
    proto.gl_max_combined_atomic_counters = ::ogl_util::getInt(GL_MAX_COMBINED_ATOMIC_COUNTERS);
    ...
    proto.gl_max_combined_image_uniforms = ::ogl_util::getInt(GL_MAX_COMBINED_IMAGE_UNIFORMS);
    ...
    proto.gl_max_compute_atomic_counters = ::ogl_util::getInt(GL_MAX_COMPUTE_ATOMIC_COUNTERS);
    ...
    proto.gl_max_compute_image_uniforms = ::ogl_util::getInt(GL_MAX_COMPUTE_IMAGE_UNIFORMS);
    ...
    proto.gl_max_compute_shared_memory_size = ::ogl_util::getInt(GL_MAX_COMPUTE_SHARED_MEMORY_SIZE);
    ...
    proto.gl_max_compute_uniform_blocks = ::ogl_util::getInt(GL_MAX_COMPUTE_UNIFORM_BLOCKS);
    proto.has_gl_max_compute_uniform_components = true;
    proto.gl_max_compute_uniform_components = ::ogl_util::getInt(GL_MAX_COMPUTE_UNIFORM_COMPONENTS);
    ...
    proto.gl_max_depth_texture_samples = ::ogl_util::getInt(GL_MAX_DEPTH_TEXTURE_SAMPLES);
    proto.has_gl_max_fragment_atomic_counters = true;
    proto.gl_max_fragment_atomic_counters = ::ogl_util::getInt(GL_MAX_FRAGMENT_ATOMIC_COUNTERS);
    ...
    proto.gl_max_fragment_image_uniforms = ::ogl_util::getInt(GL_MAX_FRAGMENT_IMAGE_UNIFORMS);
    ...
    proto.gl_max_framebuffer_height = ::ogl_util::getInt(GL_MAX_FRAMEBUFFER_HEIGHT);
    proto.has_gl_max_framebuffer_samples = true;
    proto.gl_max_framebuffer_samples = ::ogl_util::getInt(GL_MAX_FRAMEBUFFER_SAMPLES);
    ...
    proto.gl_max_vertex_atomic_counters = ::ogl_util::getInt(GL_MAX_VERTEX_ATOMIC_COUNTERS);
    ...
    proto.gl_max_vertex_attrib_bindings = ::ogl_util::getInt(GL_MAX_VERTEX_ATTRIB_BINDINGS);
    ...
    proto.gl_max_vertex_attrib_stride = ::ogl_util::getInt(GL_MAX_VERTEX_ATTRIB_STRIDE);
    proto.has_gl_max_vertex_image_uniforms = true;
    proto.gl_max_vertex_image_uniforms = ::ogl_util::getInt(GL_MAX_VERTEX_IMAGE_UNIFORMS);
    ...
    proto.gl_max_shader_storage_block_size = ::ogl_util::getInt64(GL_MAX_SHADER_STORAGE_BLOCK_SIZE);

    ::ogl_util::glGetIntegeri_v = reinterpret_cast<::ogl_util::FuncTypeGlGetIntegeri_v>(
...
void addOglConstsV3_2(androidgamesdk_deviceinfo_GameSdkDeviceInfo_OpenGl& proto,
    ...
    proto.gl_layer_provoking_vertex = ::ogl_util::getInt(GL_LAYER_PROVOKING_VERTEX);
    ...
    proto.gl_max_debug_group_stack_depth = ::ogl_util::getInt(GL_MAX_DEBUG_GROUP_STACK_DEPTH);
    ...
    proto.gl_max_debug_message_length = ::ogl_util::getInt(GL_MAX_DEBUG_MESSAGE_LENGTH);
    proto.has_gl_max_framebuffer_layers = true;
    proto.gl_max_framebuffer_layers = ::ogl_util::getInt(GL_MAX_FRAMEBUFFER_LAYERS);
    proto.has_gl_max_geometry_atomic_counters = true;
    proto.gl_max_geometry_atomic_counters = ::ogl_util::getInt(GL_MAX_GEOMETRY_ATOMIC_COUNTERS);
    ...
    proto.gl_max_geometry_image_uniforms = ::ogl_util::getInt(GL_MAX_GEOMETRY_IMAGE_UNIFORMS);
    proto.has_gl_max_geometry_input_components = true;
    proto.gl_max_geometry_input_components = ::ogl_util::getInt(GL_MAX_GEOMETRY_INPUT_COMPONENTS);
    proto.has_gl_max_geometry_output_components = true;
    proto.gl_max_geometry_output_components = ::ogl_util::getInt(GL_MAX_GEOMETRY_OUTPUT_COMPONENTS);
    proto.has_gl_max_geometry_output_vertices = true;
    proto.gl_max_geometry_output_vertices = ::ogl_util::getInt(GL_MAX_GEOMETRY_OUTPUT_VERTICES);
    ...
    proto.has_gl_max_geometry_uniform_blocks = proto.gl_max_geometry_uniform_blocks = true;
    ...
    proto.gl_max_tess_patch_components = ::ogl_util::getInt(GL_MAX_TESS_PATCH_COMPONENTS);
    proto.has_gl_max_texture_buffer_size = true;
    proto.gl_max_texture_buffer_size = ::ogl_util::getInt(GL_MAX_TEXTURE_BUFFER_SIZE);
    ...
    proto.gl_reset_notification_strategy = ::ogl_util::getInt(GL_RESET_NOTIFICATION_STRATEGY);
...
int addGl(androidgamesdk_deviceinfo_GameSdkDeviceInfo_OpenGl& proto,
    ...
    dataHolder.shading_language_version.copy(::ogl_util::getString(GL_SHADING_LANGUAGE_VERSION));
    ...
    if (glVerMajor >= 3) {
        ...
        ::ogl_util::glGetStringi = reinterpret_cast<::ogl_util::FuncTypeGlGetstringi>(
                eglGetProcAddress("glGetStringi"));
        for (int i = 0; i < numExts; i++) {
            dataHolder.extension.addCopy(::ogl_util::getStringIndexed(GL_EXTENSIONS, i));
        }
    } else {
        String exts;
...
bool protoEncodeString(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
...
bool protoEncodeStringVector(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
    const StringVector& strings = **(StringVector**)(arg);
    for (int i = 0; i < strings.size; i++) {
        if (!pb_encode_tag_for_field(stream, field)) return false;
        const char* chars = strings.data[i].data.get();
        if (!pb_encode_string(stream, (pb_byte_t*)chars, strlen(chars))) return false;
    }
    return true;
}
bool protoEncodeInt32Vector(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
...
bool protoEncodeFloatVector(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
...
bool protoEncodeCpuFreqs(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
...
bool testCompressedTextureRendering(StringVector& errors, EGLDisplay eglDisplay,
                                    EGLSurface eglSurface, TextureTestCase* config) {
    if (!config) {
        errors.addCopy("testCompressedTextureRendering: a test case is misconfigured.");
        return false;
    }
    ...
    if (!basicTextureRenderer.loadProgramObject()) {
        errors.addCopy("testCompressedTextureRendering: Unable to load program object.");
        return false;
    }

    if (!basicTextureRenderer.loadTexture(config->internalformat, config->width, config->height,
                                          config->dataSize, config->data)) {
        errors.addCopy("testCompressedTextureRendering: Unable to load texture.");
        return false;
    }

    if (!basicTextureRenderer.draw(OPENGL_TEST_VIEW_WIDTH, OPENGL_TEST_VIEW_HEIGHT)) {
    ...
    glReadPixels(0, 0, OPENGL_TEST_VIEW_WIDTH, OPENGL_TEST_VIEW_HEIGHT, GL_RGBA, GL_UNSIGNED_BYTE,
                 pixelsData);
    if (flushGlErrors("testCompressedTextureRendering (glReadPixels)", errors) != 0) {
        return false;
    }

    // Delta check is an approximate (or exact if delta is all 0) check of
    // the rendered pixels
    for (size_t i = 0; i < OPENGL_TEST_VIEW_WIDTH * OPENGL_TEST_VIEW_HEIGHT; i++) {
        if (abs(pixelsData[i].r - config->expectedPixelsColor.r) > config->allowedPixelsDelta.r ||
            abs(pixelsData[i].g - config->expectedPixelsColor.g) > config->allowedPixelsDelta.g ||
            abs(pixelsData[i].b - config->expectedPixelsColor.b) > config->allowedPixelsDelta.b) {
            ...
            snprintf(renderingError, sizeof(renderingError),
                     ...
                     "Got: %d;%d;%d.",
                     i, config->internalformat, pixelsData[i].r, pixelsData[i].g, pixelsData[i].b);
...
void addGlCompressedTexturesRendering(
    ...
    auto& rendered_compressed_texture_formats = openglProto.rendered_compressed_texture_formats;

    // ASTC tests
    if (openGlDataHolder.compTexFormats.includes(GL_COMPRESSED_RGBA_ASTC_4x4_KHR)) {
        ...
        rendered_compressed_texture_formats.gl_compressed_rgba_astc_4x4_khr =
                testCompressedTextureRendering(errors, eglDisplay, eglSurface,
                                               getCompressedTextureTestCase(
                                                       GL_COMPRESSED_RGBA_ASTC_4x4_KHR));
    }
    if (openGlDataHolder.compTexFormats.includes(GL_COMPRESSED_RGBA_ASTC_6x6_KHR)) {
    ...
    if (openGlDataHolder.compTexFormats.includes(GL_COMPRESSED_RGBA_ASTC_8x8_KHR)) {
    ...
    // PVRTC tests
    if (openGlDataHolder.compTexFormats.includes(GL_COMPRESSED_RGB_PVRTC_2BPPV1_IMG)) {
    ...
    if (openGlDataHolder.compTexFormats.includes(GL_COMPRESSED_RGBA_PVRTC_2BPPV1_IMG)) {
    ...
    if (openGlDataHolder.compTexFormats.includes(GL_COMPRESSED_RGB_PVRTC_4BPPV1_IMG)) {
    ...
    if (openGlDataHolder.compTexFormats.includes(GL_COMPRESSED_RGBA_PVRTC_4BPPV1_IMG)) {
    ...
    // DXT tests
    if (openGlDataHolder.compTexFormats.includes(GL_COMPRESSED_RGBA_S3TC_DXT1_EXT)) {
    ...
    if (openGlDataHolder.compTexFormats.includes(GL_COMPRESSED_RGBA_S3TC_DXT5_EXT)) {
...
int createProto(androidgamesdk_deviceinfo_GameSdkDeviceInfoWithErrors& proto,
    ...
    if (numErrorsEgl == 0) {
        ...
        protoGl.shading_language_version.arg = &dataHolder.ogl.shading_language_version;
        ...
        protoGl.gl_compressed_texture_formats.funcs.encode = &protoEncodeInt32Vector;
    ...
    if (numErrorsEgl == 0 && eglDisplay != nullptr && eglContext != nullptr &&
        eglSurface != nullptr) {
        addGlCompressedTexturesRendering(eglDisplay, eglSurface, info.open_gl, dataHolder.ogl,
                                         dataHolder.errors);
    } else {
        numErrors++;
        dataHolder.errors.addCopy("Compressed textures: skipping because EGL errors");
    }

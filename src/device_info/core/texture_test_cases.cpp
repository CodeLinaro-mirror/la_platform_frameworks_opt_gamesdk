...
constexpr size_t pvrDxtHeaderSize = 52; // PVR header with no metadata is 52 bytes
RGB dxtAllowedDelta{1, 1, 2};
constexpr size_t pvrEtc2HeaderSize = 52; // PVR header with no metadata is 52 bytes
constexpr size_t pvrEtc1HeaderSize = 52; // PVR header with no metadata is 52 bytes

constexpr size_t allCompressedTextureTestCasesCount = 11;
TextureTestCase allCompressedTextureTestCases[allCompressedTextureTestCasesCount] =
        {{GL_COMPRESSED_RGBA_ASTC_4x4_KHR, greenTextureWidth, greenTextureHeight,
          green32_astc_4x4_astc_len - astcHeaderSize, &green32_astc_4x4_astc[astcHeaderSize],
          expectedPixelsColor, noDeltaAllowed},
         {GL_COMPRESSED_RGBA_ASTC_6x6_KHR, greenTextureWidth, greenTextureHeight,
          green32_astc_6x6_astc_len - astcHeaderSize, &green32_astc_6x6_astc[astcHeaderSize],
          expectedPixelsColor, noDeltaAllowed},
         {GL_COMPRESSED_RGBA_ASTC_8x8_KHR, greenTextureWidth, greenTextureHeight,
          green32_astc_8x8_astc_len - astcHeaderSize, &green32_astc_8x8_astc[astcHeaderSize],
          expectedPixelsColor, noDeltaAllowed},

         // PVRTC tests
         {GL_COMPRESSED_RGB_PVRTC_2BPPV1_IMG, greenTextureWidth, greenTextureHeight,
          green32_pvrtci_2bpp_RGB_pvr_len - pvrHeaderSize,
          &green32_pvrtci_2bpp_RGB_pvr[pvrHeaderSize], expectedPixelsColor, pvrtcAllowedDelta,
          (RGBA*)green32_pvrtci_2bpp_RGB_expected_rgba},
         {GL_COMPRESSED_RGBA_PVRTC_2BPPV1_IMG, greenTextureWidth, greenTextureHeight,
          green32_pvrtci_2bpp_RGBA_pvr_len - pvrHeaderSize,
          &green32_pvrtci_2bpp_RGBA_pvr[pvrHeaderSize], expectedPixelsColor, pvrtcAllowedDelta,
          (RGBA*)green32_pvrtci_2bpp_RGB_expected_rgba},
         {GL_COMPRESSED_RGB_PVRTC_4BPPV1_IMG, greenTextureWidth, greenTextureHeight,
          green32_pvrtci_4bpp_RGB_pvr_len - pvrHeaderSize,
          &green32_pvrtci_4bpp_RGB_pvr[pvrHeaderSize], expectedPixelsColor, pvrtcAllowedDelta,
          (RGBA*)green32_pvrtci_4bpp_RGB_expected_rgba},
         {GL_COMPRESSED_RGBA_PVRTC_4BPPV1_IMG, greenTextureWidth, greenTextureHeight,
          green32_pvrtci_4bpp_RGBA_pvr_len - pvrHeaderSize,
          &green32_pvrtci_4bpp_RGBA_pvr[pvrHeaderSize], expectedPixelsColor, pvrtcAllowedDelta,
          (RGBA*)green32_pvrtci_4bpp_RGB_expected_rgba},

         // DXT tests
         {GL_COMPRESSED_RGBA_S3TC_DXT1_EXT, greenTextureWidth, greenTextureHeight,
          green32_dxt1_bc1_pvr_len - pvrDxtHeaderSize, &green32_dxt1_bc1_pvr[pvrDxtHeaderSize],
          expectedPixelsColor, dxtAllowedDelta},
         {GL_COMPRESSED_RGBA_S3TC_DXT5_EXT, greenTextureWidth, greenTextureHeight,
          green32_dxt5_bc3_pvr_len - pvrDxtHeaderSize, &green32_dxt5_bc3_pvr[pvrDxtHeaderSize],
          expectedPixelsColor, dxtAllowedDelta, (RGBA*)green32_dxt5_bc3_expected_rgba},

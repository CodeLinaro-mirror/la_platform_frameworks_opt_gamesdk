...
public:
    ...
    void CallSSVMethod(const char* name, const char* a, const char* b) {
        obj_.CallVoidMethod(name, "(Ljava/lang/String;Ljava/lang/String;)V", String(a).J(),
                            String(b).J());
    }
    ...
    void CallOVMethod(const char* name, const char* parameterClassA, const Object& a) {
        std::stringstream str;
    ...
    Object CallOOOMethod(const char* name, const char* parameterClassA, const Object& a,
                         const char* parameterClassB, const Object& b, const char* returnClass) {
        std::stringstream str;
        str << "(L" << parameterClassA << ";L" << parameterClassB << ";)L" << returnClass << ";";
        jobject o =
                obj_.CallObjectMethod(name, str.str().c_str(), (jobject)a.obj_, (jobject)b.obj_);
        return Object(o);
    }
    ...
    Object CallSIIOMethod(const char* name, const char* a, int b, int c, const char* returnClass) {
        std::stringstream str;
        str << "(Ljava/lang/String;II)L" << returnClass << ";";
        jobject o = obj_.CallObjectMethod(name, str.str().c_str(), String(a).J(), b, c);
        return Object(o);
    }
    Object CallSOMethod(const char* name, const char* a, const char* returnClass) {
        std::stringstream str;
...
public:
    OutputStreamWriter(OutputStream& o, const std::string& s)
          : Object("java/io/OutputStreamWriter", "(Ljava/io/OutputStream;Ljava/lang/String;)V",
                   (jobject)o.obj_, String(s.c_str()).J()) {}
};
...
public:
    InputStreamReader(const InputStream& is, const std::string& s)
          : Reader(Object("java/io/InputStreamReader", "(Ljava/io/InputStream;Ljava/lang/String;)V",
...
public:
    ...
    URLConnection openConnection() {
        return URLConnection(
                Object(obj_.CallObjectMethod("openConnection", "()Ljava/net/URLConnection;")));
    }
};
...
public:
    ...
    std::vector<unsigned char> digest(const std::vector<unsigned char>& bs) const {
        ...
        env->SetByteArrayRegion(jbs, 0, bs.size(), reinterpret_cast<const jbyte*>(bs.data()));
        jbyteArray out =
                reinterpret_cast<jbyteArray>(obj_.CallObjectMethod("digest", "([B)[B", jbs));
...
public:
    ...
    int heightPixels() const {
        return obj_.GetIntField("heightPixels");
    }
    int widthPixels() const {
        return obj_.GetIntField("widthPixels");
    }
};
...
public:
    ...
    ApplicationInfo applicationInfo() const {
        auto appInfo =
                obj_.GetObjectField("applicationInfo", "[Landroid/content/pm/ApplicationInfo;");
...
public:
    ...
    std::vector<FeatureInfo> getSystemAvailableFeatures() {
        auto env = Env();
        auto jfeatures =
                CallAOMethod("getSystemAvailableFeatures", "android/content/pm/FeatureInfo");
...
public:
    static constexpr const char* ACTION_BATTERY_CHANGED = "android.intent.action.BATTERY_CHANGED";
...
public:
    ...
    IntentFilter(const char* action)
          : Object("android/content/IntentFilter", "(Ljava/lang/String;)V", String(action).J()) {}
};
...
public:
    ...
    java::Object registerReceiver(BroadcastReceiver& broadcastReceiver,
        ...
        return CallOOOMethod("registerReceiver", "android/content/BroadcastReceiver",
                             broadcastReceiver, "android/content/IntentFilter", intentFilter,
...
public:
    static uint64_t getNativeHeapAllocatedSize() {
        ...
        if (env != nullptr) {
            ...
            if (method != NULL) return (uint64_t)env->CallStaticLongMethod(clz, method);
        }
        return 0;
    }
    ...
    static uint64_t getNativeHeapFreeSize() {
        ...
        if (env != nullptr) {
            ...
            obj.Cast("android/os/Debug");
            jclass clz = obj;
            jmethodID method = env->GetStaticMethodID(clz, "getNativeHeapFreeSize", "()J");
            if (method != NULL) return (uint64_t)env->CallStaticLongMethod(clz, method);
        }
        return 0;
    }
    ...
    static uint64_t getNativeHeapSize() {
        ...
        if (env != nullptr) {
            ...
            obj.Cast("android/os/Debug");
            jclass clz = obj;
            jmethodID method = env->GetStaticMethodID(clz, "getNativeHeapSize", "()J");
            if (method != NULL) return (uint64_t)env->CallStaticLongMethod(clz, method);
        }
        return 0;
    }
...
public:
    static int myPid() {
        ...
        if (env != nullptr) {
            ...
            if (method != NULL) return (uint64_t)env->CallStaticIntMethod(clz, method);
        }
        return 0;
    }
}; // Class Process
...
public:
    ...
    int getIntProperty(int id) {
        return CallIIMethod("getIntProperty", id);
    }
};
...
public:
    ...
    bool isPowerSaveMode() {
        return CallVZMethod("isPowerSaveMode");
    }
};
...
public:
    ...
    MemoryInfo() : java::Object("android/app/ActivityManager$MemoryInfo", "()V") {}
    int64_t threshold() const {
        return obj_.GetLongField("threshold");
    }
    int64_t availMem() const {
        return obj_.GetLongField("availMem");
    }
    bool lowMemory() const {
        return obj_.GetBooleanField("lowMemory");
    }
    int64_t totalMem() const {
        return obj_.GetLongField("totalMem");
    }
};
...
public:
    ...
    void getMemoryInfo(MemoryInfo& memoryInfo) {
        CallOVMethod("getMemoryInfo", "android/app/ActivityManager$MemoryInfo", memoryInfo);
    }
    int32_t getMemoryClass() {
        return CallVIMethod("getMemoryClass");
    }
    int32_t getLargeMemoryClass() {
        return CallVIMethod("getLargeMemoryClass");
    }
    bool isLowRamDevice() {
        return CallVZMethod("isLowRamDevice");
    }
    java::util::List getHistoricalProcessExitReasons(std::string& packageName, int pid,
                                                     int maxNum) {
        return CallSIIOMethod("getHistoricalProcessExitReasons", packageName.c_str(), pid, maxNum,
                              "java/util/List");
    }
};

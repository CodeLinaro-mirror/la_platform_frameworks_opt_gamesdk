...
bool WindForwardOverArrays(Iterator& i, const Iterator& end, char begin_ch = '[', char end_ch = ']',
...
template <typename Iterator>
bool WindForwardOverRegex(const std::string& regex_str, Iterator& i, const Iterator& end,
                          std::string* inner = nullptr) {
...
bool CompareIgnoringWhitespace(std::string s0, std::string s1, std::string* error_msg) {
